...
namespace Negocio.SISU
{
    ...
    public class BIngresoServUrb
    {
        ...
        public List<Valorizacion> ObtieneValorizacionServicios(string CodCoberturaOri, string CodCoberturaDes, int Producto, decimal Peso, int Alto, int Ancho, int Largo, bool  optionOfiDire)
        {
            ...
            try
            {
                respuesta = DIngServ.ObtieneValorizacionServicios(CodCoberturaOri, CodCoberturaDes, Producto, Peso, Alto, Ancho, Largo, optionOfiDire);
        ...
        public List<ulong> RegistraServicioUrbano(ServicioUrbano Servicio, bool OptionOfiDirec)
        {
            ...
            try
            {
                respuesta = DIngServ.RegistraServicioUrbano(Servicio, OptionOfiDirec);
            }
            catch (ExceptionFuncional ef)
            {
                throw ef;
        ...
        public List<Coberturas> CargaCoberturasOfiComercial()
        {
            ...
            try
            {
               ...
               Respuesta = DIngServ.CargaCoberturasOfiComercial();
                if (Respuesta.Count == 0)
                    throw new ExceptionFuncional("No existen coberturas.");
            }
            catch (ExceptionFuncional ef) { throw ef; }
            catch (Exception ex) { throw ex; }
            return Respuesta;
        ...
        public List<Coberturas> CargaOfiComerciales(string Dato)
        {
            ...
            try
            {
                Respuesta = DIngServ.CargaOfiComerciales(Dato);
                if (Respuesta.Count == 0)
                    throw new ExceptionFuncional("No existen Oficinas Comerciales.");
            }
            catch (ExceptionFuncional ef) { throw ef; }
            catch (Exception ex) { throw ex; }
            return Respuesta;
        ...
        public List<Coberturas> CargaDireccionOfCom(string Dato)
        {
            ...
            try
            {
                Respuesta = DIngServ.CargaDireccionOfCom(Dato);
                if (Respuesta.Count == 0)
                    throw new ExceptionFuncional("No existen Direcciones.");
            }
            catch (ExceptionFuncional ef) { throw ef; }
            catch (Exception ex) { throw ex; }
            return Respuesta;
        ...
        //List<Coberturas> Lista_OfComerciales = new List<Coberturas>();
        // try
        // {

        //     Lista_OfComerciales = DIngServ.CargaCoberturasOfiComercial();
        //     if (Lista_OfComerciales.Count == 0)
        //         throw new ExceptionFuncional("No existen coberturas.");
        // }
        // catch (ExceptionFuncional ef)
        // {
