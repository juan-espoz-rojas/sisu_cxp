...
<!--      JCRH
                                    <tr>
                                        ...
                                        <td class=" tleft no-padding" style="width:66% ;vertical-align: middle; padding-left:60px">
									        ...
									        CssClass="bold " ForeColor="#FF3300" Text="Formato de correo no valido"
									        ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="SUGroup"></asp:regularexpressionvalidator>
                                        </td>
                                    </tr>
-->
                                </table>
