...
<!--jcrh-->
   ...
   <%--                                 <asp:TextBox CssClass="w-100 uppercase" ID="TextBox1" runat="server" 
									...
									<asp:regularexpressionvalidator id="Regularexpressionvalidator2" runat="server" ControlToValidate="txtMailDestino" ErrorMessage="Formato de correo no valido" 
										ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="GroupPaso4"></asp:regularexpressionvalidator>

                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender2" runat="server"  WarningIconImageUrl="~/Resources/Images/warn.png"
                                        Width="200px" Enabled="True" TargetControlID="rfvMailDestino">
                                    </ajaxToolkit:ValidatorCalloutExtender>
									<ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server"  WarningIconImageUrl="~/Resources/Images/warn.png"
                                        Width="200px" Enabled="True" TargetControlID="revEmail">
                                    </ajaxToolkit:Validat--%>orCalloutExtender>




                                    <asp:TextBox CssClass="w-100 uppercase" ID="txtmailremitente" runat="server" 
                                        placeholder="Correo Electrónico" ClientIDMode="Static" MaxLength="200" ></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                        ControlToValidate="txtmailremitente" Display="None"
                                        ErrorMessage="Indique el mail del remitente."
                                    ...
                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender1" runat="server" WarningIconImageUrl="~/Resources/Images/warn.png" 
                                        Width="200px" Enabled="True" 
                                        PopupPosition="BottomRight" TargetControlID="rfv_MailRemitente" >
                                    </ajaxToolkit:ValidatorCalloutExtender>
									
                                    <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server"  WarningIconImageUrl="~/Resources/Images/warn.png"
                                        Width="200px" Enabled="True" TargetControlID="revEmail">
                                    </ajaxToolkit:ValidatorCalloutExtender>

 <!--jcrh   
                                        <asp:RequiredFieldValidator ID="rfv_MailRemitente" runat="server" ControlToValidate="txtmailremitente" Display="None" 
                                            ErrorMessage="Indique el correo de contacto." ValidationGroup="GroupPaso3"></asp:RequiredFieldValidator>
                                        <ajaxToolkit:ValidatorCalloutExtender ID="ValidatorCalloutExtender91" runat="server" Enabled="True" 
                                            PopupPosition="BottomRight" TargetControlID="rfv_MailRemitente" WarningIconImageUrl="~/Resources/Images/warn.png" Width="200px">
                                        </ajaxToolkit:ValidatorCalloutExtender>
