...
namespace Dominio.Objects
{
    ...
    public class Direccion
    {
        ...
        string _Numeracion = string.Empty;
        ...
        int _TipoAdmisionEntrega = default(int);
        ...
        public int TipoAdmisionEntrega
        {
            get { return _TipoAdmisionEntrega; }
            set { _TipoAdmisionEntrega = value; }
        }
