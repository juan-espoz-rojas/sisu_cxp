<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccesoDenegado.aspx.cs" Inherits="Presentacion.AccesoDenegado" %>
...
<head id="Head1" runat="server">
        ...
        <script src="Resources/Scripts/run_prettify.js" type="text/javascript"></script>
...
<body>
    <form id="Formulario" runat="server">
        <header id="header">   
            <div class="container">
                <div class="row">
                    <table border="0" style="border:none;width: 1000px;" align="center">
                        <tr>
    ...
    <div id="main">
        <div class="container">
            <div class="row">
                <table style="border-style: none; text-align: center; width: 100%; height:500px">
                    <tr>
                        <td style="border-style: none; text-align: center; vertical-align:middle">
