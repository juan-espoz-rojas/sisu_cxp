...
<asp:Content ID="Content2" ContentPlaceHolderID="MessagesContent" runat="server"></asp:Content>
                ...
                <tr>
                    <td class="w-50">
                        <div class="container widget">
                            <div class="row">
                                <div class="box-features-content">
                                    <h2 class="feature-title">¿dónde retiramos?</h2>
                                    <asp:TextBox CssClass="w-100 uppercase" ID="txtDirRemitente" runat="server" 
                                        placeholder="Calle, Número, Comuna" ClientIDMode="Static" 
                                        MaxLength="250"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv_DirRemitente" runat="server" 
                                        ControlToValidate="txtDirRemitente" Display="None"
                                        ErrorMessage="Indique dirección de retiro." ValidationGroup="GroupPaso3"></asp:RequiredFieldValidator>
                                    <ajaxToolkit:ValidatorCalloutExtender ID="rfv_DirRemitente_VCE" runat="server" 
                                        Width="200px" Enabled="True" TargetControlID="rfv_DirRemitente" WarningIconImageUrl="~/Resources/Images/warn.png"
                                        PopupPosition="BottomRight">
                                    </ajaxToolkit:ValidatorCalloutExtender>
                                    <br />
                                    <br />
									<asp:TextBox CssClass="w-100 uppercase" ID="txtComplementoRemitente" runat="server"
										placeholder="Complemento" ClientIDMode="Static" MaxLength="50"></asp:TextBox>
									<br />
									<br />
                                    <asp:TextBox CssClass="w-100 uppercase" ID="txtNomRemitente" runat="server" 
                                        placeholder="Nombre o Contacto de Retiro" ClientIDMode="Static" 
                                        MaxLength="40" ></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvNomRemitente" runat="server" 
                                        ControlToValidate="txtNomRemitente" Display="None"
                                        ErrorMessage="Indique nombre de contacto." ValidationGroup="GroupPaso3"></asp:RequiredFieldValidator>
                                    <ajaxToolkit:ValidatorCalloutExtender ID="rfvNomRemitente_VCE" runat="server" WarningIconImageUrl="~/Resources/Images/warn.png"
                                        Width="200px"  Enabled="True" PopupPosition="BottomRight" 
                                        TargetControlID="rfvNomRemitente" >
                                    </ajaxToolkit:ValidatorCalloutExtender>
                                    <br />
                                    <br />
                                    <asp:TextBox CssClass="w50 uppercase" ID="txtTelRemitente" runat="server" 
                                        placeholder="Teléfono" ClientIDMode="Static" MaxLength="15" ></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv_FonoRemitente" runat="server" 
                                        ControlToValidate="txtTelRemitente" Display="None"
                                        ErrorMessage="Indique el teléfono de retiro." 
                                        ValidationGroup="GroupPaso3"></asp:RequiredFieldValidator>
                                    <ajaxToolkit:ValidatorCalloutExtender ID="rfv_FonoRemitente_VCE" runat="server" WarningIconImageUrl="~/Resources/Images/warn.png"
                                        Width="200px"  Enabled="True" PopupPosition="BottomRight" 
                                        TargetControlID="rfv_FonoRemitente" >
                                    </ajaxToolkit:ValidatorCalloutExtender>
                                </div>
                            </div>
                        </div>
